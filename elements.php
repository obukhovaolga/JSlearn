...
<html lang="ru">
  ...
  <body class="p-3">
    ...
    <div class="task-1">
      ...
      <input type="text" class="task1-input" value="" placeholder="Введите число и нажмите">
      <span class="input-result" value=""></span>
      <button type="button" class="btn-result">Результат</button>
    </div>
    <div class="task-2">
      <h2>Задание 2</h2>
      <p>Напишите функцию, которая параметром принимает цвет (color), а затем применяет этот цвет к квадрату ниже</p>
      <div class="box"></div>
      <input type="text" class="color" value="" placeholder="Введите цвет">
      <button type="button" class="change-color">Сменить цвет</button>
    </div>
    <div class="task-3">
      <h2>Задание 3</h2>
      ...
      <button type="button" class="btn-img">Поменять картинки</button>
    </div>
    <div class="task-4">
      <h2>Задание 4</h2>
      ...
      **Напишите "переключатель" - при первом вызове функции квадрат показывается, при втором - прячется и т.д.
      ...
      <button type="button" class="btn-box">Показать/скрыть элемент</button>
      <div class="box box2 d-none"></div>
    </div>
